 ...
 * RU: Безопасный редирект через wp_nonce_url (Arbitrary Redirect Protection закрыт).
 * EN: Secure redirect via wp_nonce_url (Arbitrary Redirect Protection is closed).
 */
